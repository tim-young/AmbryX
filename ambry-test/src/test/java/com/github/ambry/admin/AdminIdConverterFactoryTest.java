...
/**
 * Unit tests for {@link AdminIdConverterFactory}.
 */
public class AdminIdConverterFactoryTest {

  /**
   * Tests the instantiation and use of the {@link IdConverter} instance returned through the
   * {@link AdminIdConverterFactory}.
   * @throws Exception
   */
  @Test
  public void adminIdConverterTest()
    ...
    AdminIdConverterFactory adminIdConverterFactory =
        new AdminIdConverterFactory(verifiableProperties, new MetricRegistry());
    IdConverter idConverter = adminIdConverterFactory.getIdConverter();
